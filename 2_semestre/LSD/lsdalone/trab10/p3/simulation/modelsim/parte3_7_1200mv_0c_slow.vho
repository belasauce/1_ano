...
-- CLOCL_50	=>  Location: PIN_Y27,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \CLOCL_50~inputclkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \CLOCL_50~input_o\ : std_logic;
SIGNAL \CLOCL_50~inputclkctrl_outclk\ : std_logic;
...
SIGNAL \inst3|s_value[0]~feeder_combout\ : std_logic;
...
SIGNAL \inst3|s_value~1_combout\ : std_logic;
SIGNAL \inst3|Add0~0_combout\ : std_logic;
SIGNAL \inst3|s_value~2_combout\ : std_logic;
SIGNAL \inst3|s_value[3]~feeder_combout\ : std_logic;
...
ww_KEY <= KEY;
ww_SW <= SW;
ww_CLOCL_50 <= CLOCL_50;
ww_devoe <= devoe;
ww_devclrn <= devclrn;
ww_devpor <= devpor;

\inst|s_memory_rtl_0|auto_generated|ram_block1a0_PORTADATAIN_bus\ <= (gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & \SW[15]~input_o\
& \SW[14]~input_o\ & \SW[13]~input_o\ & \SW[12]~input_o\ & \SW[11]~input_o\ & \SW[10]~input_o\ & \SW[9]~input_o\ & \SW[8]~input_o\);

\inst|s_memory_rtl_0|auto_generated|ram_block1a0_PORTAADDR_bus\ <= (\SW[7]~input_o\ & \SW[6]~input_o\ & \SW[5]~input_o\ & \SW[4]~input_o\);

\inst|s_memory_rtl_0|auto_generated|ram_block1a0_PORTBADDR_bus\ <= (\inst3|s_value~3_combout\ & \inst3|s_value~2_combout\ & \inst3|s_value~1_combout\ & \inst3|s_value~0_combout\);
...
\CLOCL_50~inputclkctrl_INCLK_bus\ <= (vcc & vcc & vcc & \CLOCL_50~input_o\);
...
\CLOCL_50~input\ : cycloneive_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	simulate_z_as => "z")
...
-- Location: CLKCTRL_G9
\CLOCL_50~inputclkctrl\ : cycloneive_clkctrl
-- pragma translate_off
GENERIC MAP (
...
-- pragma translate_on
PORT MAP (
	inclk => \CLOCL_50~inputclkctrl_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	outclk => \CLOCL_50~inputclkctrl_outclk\);
...
-- pragma translate_on
PORT MAP (
	clk => \CLOCL_50~inputclkctrl_outclk\,
...
-- Equation(s):
-- \inst2|LessThan0~5_combout\ = (((!\inst2|s_divCounter\(15)) # (!\inst2|s_divCounter\(12))) # (!\inst2|s_divCounter\(13))) # (!\inst2|s_divCounter\(14))
...
-- Equation(s):
-- \inst2|LessThan1~2_combout\ = (((!\inst2|s_divCounter\(2)) # (!\inst2|s_divCounter\(1))) # (!\inst2|s_divCounter\(0))) # (!\inst2|s_divCounter\(3))
...
-- Equation(s):
-- \inst2|LessThan1~3_combout\ = ((\inst2|LessThan1~2_combout\) # (!\inst2|s_divCounter\(5))) # (!\inst2|s_divCounter\(4))
...
-- Equation(s):
-- \inst2|LessThan1~5_combout\ = (\inst2|LessThan1~1_combout\) # ((\inst2|LessThan1~3_combout\ & (!\inst2|s_divCounter\(6) & \inst2|LessThan1~4_combout\)))
...
\inst3|s_value[0]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_value[0]~feeder_combout\ = \inst3|s_value~0_combout\
...
-- pragma translate_on
PORT MAP (
	datac => \inst3|s_value~0_combout\,
	combout => \inst3|s_value[0]~feeder_combout\);
...
PORT MAP (
	...
	d => \inst3|s_value[0]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst3|s_value\(0));
...
-- Equation(s):
-- \inst3|s_value~0_combout\ = (!\SW[2]~input_o\ & (\inst3|s_value\(0) $ (((\SW[0]~input_o\ & \SW[1]~input_o\)))))
...
-- Equation(s):
-- \inst3|process_0~0_combout\ = (\SW[1]~input_o\ & \SW[0]~input_o\)
...
-- Equation(s):
-- \inst3|s_value[1]~feeder_combout\ = \inst3|s_value~1_combout\
...
\inst3|s_value~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_value~1_combout\ = (!\SW[2]~input_o\ & (\inst3|s_value\(1) $ (((\inst3|process_0~0_combout\ & \inst3|s_value\(0))))))
...
PORT MAP (
	...
	datad => \inst3|s_value\(0),
	combout => \inst3|s_value~1_combout\);
...
PORT MAP (
	clk => \inst2|clkOut~clkctrl_outclk\,
	asdata => \inst3|s_value~2_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst3|s_value\(2));
...
-- Equation(s):
-- \inst3|Add0~0_combout\ = \inst3|s_value\(2) $ (((\inst3|s_value\(1) & \inst3|s_value\(0))))
...
-- pragma translate_on
PORT MAP (
	datab => \inst3|s_value\(1),
	datac => \inst3|s_value\(2),
	datad => \inst3|s_value\(0),
	combout => \inst3|Add0~0_combout\);

-- Location: LCCOMB_X105_Y14_N4
\inst3|s_value~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_value~2_combout\ = (!\SW[2]~input_o\ & ((\inst3|process_0~0_combout\ & ((\inst3|Add0~0_combout\))) # (!\inst3|process_0~0_combout\ & (\inst3|s_value\(2)))))
...
PORT MAP (
	...
	combout => \inst3|s_value~2_combout\);

-- Location: LCCOMB_X105_Y14_N6
\inst3|s_value[3]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_value[3]~feeder_combout\ = \inst3|s_value~3_combout\
...
-- pragma translate_on
PORT MAP (
	datad => \inst3|s_value~3_combout\,
	combout => \inst3|s_value[3]~feeder_combout\);
...
PORT MAP (
	clk => \inst2|clkOut~clkctrl_outclk\,
	d => \inst3|s_value[3]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst3|s_value\(3));
...
-- Equation(s):
-- \inst3|Add0~1_combout\ = \inst3|s_value\(3) $ (((\inst3|s_value\(2) & (\inst3|s_value\(0) & \inst3|s_value\(1)))))
...
-- Equation(s):
-- \inst3|s_value~3_combout\ = (!\SW[2]~input_o\ & ((\inst3|process_0~0_combout\ & ((\inst3|Add0~1_combout\))) # (!\inst3|process_0~0_combout\ & (\inst3|s_value\(3)))))
