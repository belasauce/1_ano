...
SIGNAL \inst4|s_value~4_combout\ : std_logic;
SIGNAL \SW[2]~input_o\ : std_logic;
SIGNAL \SW[1]~input_o\ : std_logic;
SIGNAL \inst4|s_value[3]~2_combout\ : std_logic;
SIGNAL \inst4|s_value~5_combout\ : std_logic;
SIGNAL \inst4|s_value~3_combout\ : std_logic;
SIGNAL \inst4|s_value~0_combout\ : std_logic;
SIGNAL \inst4|s_value~1_combout\ : std_logic;
...
SIGNAL \inst4|s_value\ : std_logic_vector(3 DOWNTO 0);
...
-- Equation(s):
-- \inst3|LessThan0~0_combout\ = (!\inst3|s_divCounter\(18) & (!\inst3|s_divCounter\(11) & (!\inst3|s_divCounter\(24) & !\inst3|s_divCounter\(16))))
...
-- Equation(s):
-- \inst3|LessThan1~1_combout\ = (((!\inst3|s_divCounter\(14)) # (!\inst3|s_divCounter\(13))) # (!\inst3|s_divCounter\(11))) # (!\inst3|s_divCounter\(12))
...
-- Equation(s):
-- \inst3|LessThan1~5_combout\ = (\inst3|LessThan1~1_combout\) # ((\inst3|LessThan1~4_combout\ & (!\inst3|s_divCounter\(6) & \inst3|LessThan1~3_combout\)))
...
PORT MAP (
	...
	datac => \inst3|s_divCounter\(15),
	datad => \inst3|LessThan1~5_combout\,
	combout => \inst3|LessThan1~6_combout\);

-- Location: LCCOMB_X36_Y12_N16
\inst3|LessThan1~7\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|LessThan1~7_combout\ = (\inst3|LessThan1~0_combout\ & (\inst3|s_divCounter\(18) & ((\inst3|s_divCounter\(17)) # (\inst3|LessThan1~6_combout\))))
...
\inst4|s_value~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst4|s_value~4_combout\ = (!\SW[0]~input_o\ & !\inst4|s_value\(0))
...
PORT MAP (
	dataa => \SW[0]~input_o\,
	datac => \inst4|s_value\(0),
	combout => \inst4|s_value~4_combout\);
...
\inst4|s_value[3]~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst4|s_value[3]~2_combout\ = (\SW[0]~input_o\) # ((\SW[2]~input_o\ & \SW[1]~input_o\))
...
PORT MAP (
	...
	datac => \SW[1]~input_o\,
	datad => \SW[0]~input_o\,
	combout => \inst4|s_value[3]~2_combout\);

-- Location: FF_X95_Y69_N25
\inst4|s_value[0]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	d => \inst4|s_value~4_combout\,
	ena => \inst4|s_value[3]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst4|s_value\(0));

-- Location: LCCOMB_X95_Y69_N10
\inst4|s_value~5\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst4|s_value~5_combout\ = (!\SW[0]~input_o\ & (\inst4|s_value\(1) $ (\inst4|s_value\(0))))
...
PORT MAP (
	dataa => \SW[0]~input_o\,
	datac => \inst4|s_value\(1),
	datad => \inst4|s_value\(0),
	combout => \inst4|s_value~5_combout\);

-- Location: FF_X95_Y69_N11
\inst4|s_value[1]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
\inst4|s_value~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst4|s_value~3_combout\ = (!\SW[0]~input_o\ & (\inst4|s_value\(2) $ (((\inst4|s_value\(0) & \inst4|s_value\(1))))))
...
PORT MAP (
	dataa => \SW[0]~input_o\,
	datab => \inst4|s_value\(0),
	datac => \inst4|s_value\(2),
	datad => \inst4|s_value\(1),
	combout => \inst4|s_value~3_combout\);

-- Location: FF_X95_Y69_N23
\inst4|s_value[2]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
\inst4|s_value~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst4|s_value~0_combout\ = (!\inst4|s_value\(1)) # (!\inst4|s_value\(2))
...
PORT MAP (
	datac => \inst4|s_value\(2),
	datad => \inst4|s_value\(1),
	combout => \inst4|s_value~0_combout\);

-- Location: LCCOMB_X95_Y69_N28
\inst4|s_value~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst4|s_value~1_combout\ = (!\SW[0]~input_o\ & (\inst4|s_value\(3) $ (((\inst4|s_value\(0) & !\inst4|s_value~0_combout\)))))
...
PORT MAP (
	dataa => \SW[0]~input_o\,
	datab => \inst4|s_value\(0),
	datac => \inst4|s_value\(3),
	datad => \inst4|s_value~0_combout\,
	combout => \inst4|s_value~1_combout\);

-- Location: FF_X95_Y69_N29
\inst4|s_value[3]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
-- Equation(s):
-- \inst|Mux0~0_combout\ = (\inst4|s_value\(2) & (\inst4|s_value\(0) & (\inst4|s_value\(3) & \inst4|s_value\(1))))
...
-- Equation(s):
-- \inst|Mux1~0_combout\ = (\inst4|s_value\(3) & (\inst4|s_value\(1) & ((\inst4|s_value\(2)) # (\inst4|s_value\(0)))))
...
-- Equation(s):
-- \inst|Mux2~0_combout\ = (\inst4|s_value\(3) & ((\inst4|s_value\(1)) # ((\inst4|s_value\(2) & \inst4|s_value\(0))))) # (!\inst4|s_value\(3) & (\inst4|s_value\(2) & (\inst4|s_value\(0) & \inst4|s_value\(1))))
...
-- Equation(s):
-- \inst|Mux3~0_combout\ = (\inst4|s_value\(3) & ((\inst4|s_value\(2)) # ((\inst4|s_value\(0)) # (\inst4|s_value\(1))))) # (!\inst4|s_value\(3) & (\inst4|s_value\(1) & ((\inst4|s_value\(2)) # (\inst4|s_value\(0)))))
...
-- Equation(s):
-- \inst|Mux4~0_combout\ = (\inst4|s_value\(1) & (((!\inst4|s_value\(0))))) # (!\inst4|s_value\(1) & ((\inst4|s_value\(3)) # ((\inst4|s_value\(2) & \inst4|s_value\(0)))))
...
-- Equation(s):
-- \inst|Mux5~0_combout\ = (!\inst4|s_value\(1) & ((\inst4|s_value\(2)) # ((\inst4|s_value\(0)) # (\inst4|s_value\(3)))))
...
-- Equation(s):
-- \inst|Mux6~0_combout\ = (\inst4|s_value\(1)) # (\inst4|s_value\(0))
