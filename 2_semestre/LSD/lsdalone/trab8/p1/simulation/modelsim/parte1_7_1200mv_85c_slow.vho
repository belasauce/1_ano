...
SIGNAL \control_unit|s_currentState.STOP1~q\ : std_logic;
...
-- Equation(s):
-- \control_unit|s_currentState~9_combout\ = (\KEY[3]~input_o\ & ((\statop_debouncer|s_pulsedOut~q\ & ((\control_unit|s_currentState.LAPVIEW~q\))) # (!\statop_debouncer|s_pulsedOut~q\ & (\control_unit|s_currentState.STOP1~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \control_unit|s_currentState.STOP1~q\,
	datab => \KEY[3]~input_o\,
...
\control_unit|s_currentState.STOP1\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \control_unit|s_currentState.STOP1~q\);

-- Location: LCCOMB_X98_Y5_N2
\control_unit|s_currentState~7\ : cycloneive_lcell_comb
-- Equation(s):
-- \control_unit|s_currentState~7_combout\ = (!\laprst_debouncer|s_pulsedOut~q\ & ((\statop_debouncer|s_pulsedOut~q\ & (\control_unit|s_currentState.STOP1~q\)) # (!\statop_debouncer|s_pulsedOut~q\ & ((\control_unit|s_currentState.LAPVIEW~q\)))))
...
-- Equation(s):
-- \control_unit|s_currentState~14_combout\ = (\KEY[3]~input_o\ & ((\control_unit|s_currentState~13_combout\) # ((\laprst_debouncer|s_pulsedOut~q\ & \control_unit|s_currentState.STOP1~q\))))
...
PORT MAP (
	...
	datab => \laprst_debouncer|s_pulsedOut~q\,
	datac => \KEY[3]~input_o\,
	datad => \control_unit|s_currentState.STOP1~q\,
...
-- Equation(s):
-- \bcd_counter|count_proc~14_combout\ = (\control_unit|s_currentState.STOPPED~q\) # ((\pulse_generator|s_counter\(0)) # (\control_unit|s_currentState.STOP1~q\))
...
-- Equation(s):
-- \control_unit|regEnb~1_combout\ = (!\control_unit|s_currentState.STOP1~q\ & !\control_unit|s_currentState.LAPVIEW~q\)
